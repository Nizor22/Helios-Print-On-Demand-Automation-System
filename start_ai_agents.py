#!/usr/bin/env python3
"""
Entry point for Helios AI Agents Service with proper error handling
"""
import sys
import os
import logging
...
def main():
    ...
    try:
        logger.info("Starting Helios AI Agents Service...")
        ...
        try:
            ...
            logger.info("Successfully imported AI agents app")
        except ImportError as e:
            logger.error(f"Failed to import AI agents app: {e}")
            logger.error(f"Import error details: {traceback.format_exc()}")
            
            # Try alternative import
            logger.info("Attempting alternative import method...")
            import helios.server_ai_agents
            app = helios.server_ai_agents.app
        ...
        logger.error(f"Fatal error starting AI agents: {e}")
